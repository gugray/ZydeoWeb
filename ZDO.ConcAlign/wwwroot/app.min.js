!function(e){if("function"==typeof define&&define.amd){if("undefined"!=typeof requirejs){var t="[history"+(new Date).getTime()+"]",n=requirejs.onError;e.toString=function(){return t},requirejs.onError=function(e){-1===e.message.indexOf(t)&&n.call(requirejs,e)}}define([],e)}return"object"!=typeof exports||"undefined"==typeof module?e():void(module.exports=e())}(function(){function e(e,t){var n=m.history!==j;n&&(m.history=j),e.apply(j,t),n&&(m.history=w)}function t(){}function n(e,t,r){if(e==v||""===e||t)e=t?e:S.href,(!T||r)&&(e=e.replace(/^[^#]*/,"")||"#",e=S.protocol.replace(/:.*$|$/,":")+"//"+S.host+U.basepath+e.replace(RegExp("^#[/]?(?:"+U.type+")?"),""));else{var t=n(),i=b.getElementsByTagName("base")[0];!r&&i&&i.getAttribute("href")&&(i.href=i.href,t=n(i.href,v,g)),r=t.d,i=t.h,e=""+e,e=/^(?:\w+\:)?\/\//.test(e)?0===e.indexOf("/")?i+e:e:i+"//"+t.g+(0===e.indexOf("/")?e:0===e.indexOf("?")?r+e:0===e.indexOf("#")?r+t.e+e:r.replace(/[^\/]+$/g,"")+e)}C.href=e;var e=/(?:([a-zA-Z0-9\-]+\:))?(?:\/\/(?:[^@]*@)?([^\/:\?#]+)(?::([0-9]+))?)?([^\?#]*)(?:(\?[^#]+)|\?)?(?:(#.*))?/.exec(C.href),t=e[2]+(e[3]?":"+e[3]:""),r=e[4]||"/",i=e[5]||"",o="#"===e[6]?"":e[6]||"",a=r+i+o,c=r.replace(RegExp("^"+U.basepath,"i"),U.type)+i;return{b:e[1]+"//"+t+a,h:e[1],g:t,i:e[2],k:e[3]||"",d:r,e:i,a:o,c:a,j:c,f:c+o}}function r(){var e;try{e=m.sessionStorage,e.setItem(V+"t","1"),e.removeItem(V+"t")}catch(t){e={getItem:function(e){return e=b.cookie.split(e+"="),1<e.length&&e.pop().split(";").shift()||"null"},setItem:function(e){var t={};(t[S.href]=w.state)&&(b.cookie=e+"="+O.stringify(t))}}}try{F=O.parse(e.getItem(V))||{}}catch(e){F={}}q(P+"unload",function(){e.setItem(V,O.stringify(F))},y)}function i(e,n,r,i){var o=0;r||(r={set:t},o=1);var a=!r.set,c=!r.get,f={configurable:g,set:function(){a=1},get:function(){c=1}};try{I(e,n,f),e[n]=e[n],I(e,n,r)}catch(e){}if(!(a&&c||(e.__defineGetter__&&(e.__defineGetter__(n,f.get),e.__defineSetter__(n,f.set),e[n]=e[n],r.get&&e.__defineGetter__(n,r.get),r.set&&e.__defineSetter__(n,r.set)),a&&c))){if(o)return y;if(e===m){try{var s=e[n];e[n]=v}catch(e){}if("execScript"in m)m.execScript("Public "+n,"VBScript"),m.execScript("var "+n+";","JavaScript");else try{I(e,n,{value:t})}catch(t){"onpopstate"===n&&(q("popstate",r=function(){D("popstate",r,y);var t=e.onpopstate;e.onpopstate=v,setTimeout(function(){e.onpopstate=t},1)},y),M=0)}e[n]=s}else try{try{var p=_.create(e);I(_.getPrototypeOf(p)===e?p:e,n,r);for(var u in e)"function"==typeof e[u]&&(p[u]=e[u].bind(e));try{i.call(p,p,e)}catch(e){}e=p}catch(t){I(e.constructor.prototype,n,r)}}catch(e){return y}}return e}function o(e,t,n){return n=n||{},e=e===Y?S:e,n.set=n.set||function(n){e[t]=n},n.get=n.get||function(){return e[t]},n}function a(e,t,n){e in H?H[e].push(t):3<arguments.length?q(e,t,n,arguments[3]):q(e,t,n)}function c(e,t,n){var r=H[e];if(r){for(e=r.length;e--;)if(r[e]===t){r.splice(e,1);break}}else D(e,t,n)}function f(e,n){var r=(""+("string"==typeof e?e:e.type)).replace(/^on/,""),o=H[r];if(o){if(n="string"==typeof e?n:e,n.target==v)for(var a=["target","currentTarget","srcElement","type"];e=a.pop();)n=i(n,e,{get:"type"===e?function(){return r}:function(){return m}});M&&(("popstate"===r?m.onpopstate:m.onhashchange)||t).call(m,n);for(var a=0,c=o.length;a<c;a++)o[a].call(m,n);return g}return G(e,n)}function s(){var e=b.createEvent?b.createEvent("Event"):b.createEventObject();e.initEvent?e.initEvent("popstate",y,y):e.type="popstate",e.state=w.state,f(e)}function p(e,t,r,i){T?J=S.href:(0===Z&&(Z=2),t=n(t,2===Z&&-1!==(""+t).indexOf("#")),t.c!==n().c&&(J=i,r?S.replace("#"+t.f):S.hash=t.f)),!$&&e&&(F[S.href]=e),W=y}function u(e){var t=J;if(J=S.href,t){z!==S.href&&s();var e=e||m.event,t=n(t,g),r=n();e.oldURL||(e.oldURL=t.b,e.newURL=r.b),t.a!==r.a&&f(e)}}function l(e){setTimeout(function(){q("popstate",function(e){z=S.href,$||(e=i(e,"state",{get:function(){return w.state}})),f(e)},y)},0),!T&&e!==g&&"location"in w&&(d(L.hash),W&&(W=y,s()))}function h(e){var t,e=e||m.event;e:{for(t=e.target||e.srcElement;t;){if("A"===t.nodeName)break e;t=t.parentNode}t=void 0}var r="defaultPrevented"in e?e.defaultPrevented:e.returnValue===y;t&&"A"===t.nodeName&&!r&&(r=n(),t=n(t.getAttribute("href",2)),r.b.split("#").shift()===t.b.split("#").shift()&&t.a&&(r.a!==t.a&&(L.hash=t.a),d(t.a),e.preventDefault?e.preventDefault():e.returnValue=y))}function d(e){var t=b.getElementById(e=(e||"").replace(/^#/,""));t&&t.id===e&&"A"===t.nodeName&&(e=t.getBoundingClientRect(),m.scrollTo(x.scrollLeft||0,e.top+(x.scrollTop||0)-(x.clientTop||0)))}var g=!0,v=null,y=!1,m=("object"==typeof window?window:this)||{};if(!m.history||"emulate"in m.history)return m.history;var E,b=m.document,x=b.documentElement,_=m.Object,O=m.JSON,S=m.location,j=m.history,w=j,A=j.pushState,R=j.replaceState,T=function(){var e=m.navigator.userAgent;return-1===e.indexOf("Android 2.")&&-1===e.indexOf("Android 4.0")||-1===e.indexOf("Mobile Safari")||-1!==e.indexOf("Chrome")||-1!==e.indexOf("Windows Phone")?!!A:y}(),$="state"in j,I=_.defineProperty,L=i({},"t")?{}:b.createElement("a"),P="",N=m.addEventListener?"addEventListener":(P="on")&&"attachEvent",k=m.removeEventListener?"removeEventListener":"detachEvent",B=m.dispatchEvent?"dispatchEvent":"fireEvent",q=m[N],D=m[k],G=m[B],U={basepath:"/",redirect:0,type:"/",init:0},V="__historyAPI__",C=b.createElement("a"),J=S.href,z="",M=1,W=y,Z=0,F={},H={},K=b.title,Q={onhashchange:v,onpopstate:v},X={setup:function(e,t,n){U.basepath=(""+(e==v?U.basepath:e)).replace(/(?:^|\/)[^\/]*$/,"/"),U.type=t==v?U.type:t,U.redirect=n==v?U.redirect:!!n},redirect:function(e,t){if(w.setup(t,e),t=U.basepath,m.top==m.self){var r=n(v,y,g).c,i=S.pathname+S.search;T?(i=i.replace(/([^\/])$/,"$1/"),r!=t&&RegExp("^"+t+"$","i").test(i)&&S.replace(r)):i!=t&&(i=i.replace(/([^\/])\?/,"$1/?"),RegExp("^"+t,"i").test(i)&&S.replace(t+"#"+i.replace(RegExp("^"+t,"i"),U.type)+S.hash))}},pushState:function(t,n,r){var i=b.title;K!=v&&(b.title=K),A&&e(A,arguments),p(t,r),b.title=i,K=n},replaceState:function(t,n,r){var i=b.title;K!=v&&(b.title=K),delete F[S.href],R&&e(R,arguments),p(t,r,g),b.title=i,K=n},location:{set:function(e){0===Z&&(Z=1),m.location=e},get:function(){return 0===Z&&(Z=1),L}},state:{get:function(){return"object"==typeof F[S.href]?O.parse(O.stringify(F[S.href])):"undefined"!=typeof F[S.href]?F[S.href]:v}}},Y={assign:function(e){T||0!==(""+e).indexOf("#")?S.assign(e):p(v,e)},reload:function(e){S.reload(e)},replace:function(e){T||0!==(""+e).indexOf("#")?S.replace(e):p(v,e,g)},toString:function(){return this.href},origin:{get:function(){return void 0!==E?E:S.origin?S.origin:S.protocol+"//"+S.hostname+(S.port?":"+S.port:"")},set:function(e){E=e}},href:T?v:{get:function(){return n().b}},protocol:v,host:v,hostname:v,port:v,pathname:T?v:{get:function(){return n().d}},search:T?v:{get:function(){return n().e}},hash:T?v:{set:function(e){p(v,(""+e).replace(/^(#|)/,"#"),y,J)},get:function(){return n().a}}};return function(){var e=b.getElementsByTagName("script"),e=(e[e.length-1]||{}).src||"";(-1!==e.indexOf("?")?e.split("?").pop():"").replace(/(\w+)(?:=([^&]*))?/g,function(e,t,n){U[t]=(n||"").replace(/^(0|false)$/,"")}),q(P+"hashchange",u,y);var t=[Y,L,Q,m,X,w];$&&delete X.state;for(var a=0;a<t.length;a+=2)for(var c in t[a])if(t[a].hasOwnProperty(c))if("object"!=typeof t[a][c])t[a+1][c]=t[a][c];else{if(e=o(t[a],c,t[a][c]),!i(t[a+1],c,e,function(e,n){n===w&&(m.history=w=t[a+1]=e)}))return D(P+"hashchange",u,y),y;t[a+1]===m&&(H[c]=H[c.substr(2)]=[])}return w.setup(),U.redirect&&w.redirect(),U.init&&(Z=1),!$&&O&&r(),T||b[N](P+"click",h,y),"complete"===b.readyState?l(g):(!T&&n().c!==U.basepath&&(W=g),q(P+"load",l,y)),g}()?(w.emulate=!T,m[N]=a,m[k]=c,m[B]=f,w):void 0});
...
var zsnippets={};
var App=App||{};App.page=function(){"use strict";function n(){var n=window.history.location||window.location,e=/https?:\/\/[^\/]+(.*)/i,t=e.exec(n);u=t[1];for(var i=!1,c=0;c<r.length;++c)if(r[c].isMyRoute(u)){null!=l&&l.name==r[c].name?l.move(u):l=r[c].getController(u),i=!0;break}i||a(),o()}function e(){return $(".popup").removeClass("visible"),history.pushState(null,null,this.href),n(),!1}function t(e){$(".popup").removeClass("visible"),history.pushState(null,null,e),n()}function o(){$(document).off("click","a.ajax",e),$(document).on("click","a.ajax",e)}function a(){$(".content-inner").html(zsnippets.badpage)}function i(n){return n.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var r=[],u=null,l=null;return $(document).ready(function(){n(),$(window).on("popstate",function(e){n()})}),{registerPage:function(n){r.push(n)},esc:i,path:function(){return u},showBadpage:a,inPageNavigate:t,reEnterCurrent:function(){l.enter()}}}();
var App=App||{};App.xlate=function(t){"use strict";function e(){$("#txtSearch").select(),setTimeout(function(){$("#txtSearch").focus()},50),$("#txtSearch").keypress(function(t){if(13==(t.keyCode||t.which))return r(),!1})}function r(){var t=$.ajax({url:"/api/search/go",type:"GET",contentType:"application/x-www-form-urlencoded; charset=UTF-8",data:{query:$("#txtSearch").val()}});t.done(function(t){a(t)}),t.fail(function(t,e,r){$(".results").text("Bunny is sad.")})}function a(t){for(var e="",r=0;r!=t.length;++r){var a=t[r];e+="<div class='item'>",e+="<div class='source'>";for(var s=!0,c=0;c!=a.source.length;++c)c==a.srcHiStart&&(e+="<span>",s=!1),c==a.srcHiStart+a.srcHiLen&&(e+="</span>",s=!0),e+=App.page.esc(a.source[c]);s||(e+="</span>",s=!0),e+="</div>",e+="<div class='target'>",s=!0;for(var c=0;c!=a.target.length;++c){n(a,c)&&(e+="</span>",s=!0);var o=i(a,c);if(o>=20){var l="hlLo";o>100&&(l="hlMid"),o>300&&(l="hlHi"),e+="<span data-score='"+o+"' class='"+l+"'>",s=!1}e+=App.page.esc(a.target[c])}s||(e+="</span>",s=!0),e+="</div>",e+="</div>"}$(".results").html(e),$(".item .source span").mouseenter(function(){for(var t=($(this).data("pairixs")+"").split(" "),e=$(this).closest(".item").find(".target"),r=0;r!=t.length;++r){var a=e.find("[data-ix='"+t[r]+"']");a.addClass("hilite")}}),$(".item .source span").mouseleave(function(){$(".item .target span").removeClass("hilite")})}function i(t,e){for(var r=0;r!=t.trgHilights.length;++r)if(t.trgHilights[r].start==e)return t.trgHilights[r].score;return-1}function n(t,e){for(var r=0;r!=t.trgHilights.length;++r)if(t.trgHilights[r].start+t.trgHilights[r].len==e)return!0;return!1}return e(),{enter:e,name:"main"}},App.page.registerPage({name:"main",isMyRoute:function(t){return""==t||"/"==t},getController:function(t){return App.xlate(t)}});