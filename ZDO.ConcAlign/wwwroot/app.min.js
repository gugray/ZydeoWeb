...
var App=App||{};App.xlate=function(e){"use strict";function t(){var e=$.ajax({url:"/api/search/go",type:"GET",contentType:"application/x-www-form-urlencoded; charset=UTF-8",data:{query:"sailor"}});e.done(function(e){n(e)}),e.fail(function(e,t,n){$(".results").text("Bunny is sad.")})}function n(e){for(var t="",n=0;n!=e.length;++n)t+="<div class='item'>",t+="<div class='source'>",t+="</div>",t+="<div class='target'>",t+="</div>",t+="</div>"}return t(),{enter:t,name:"main"}},App.page.registerPage({name:"main",isMyRoute:function(e){return""==e||"/"==e},getController:function(e){return App.xlate(e)}});