...
var App=App||{};App.xlate=function(t){"use strict";function e(){var t=window.history.location||window.location,e=/https?:\/\/[^\/]+(.*)/i,r=e.exec(t),n=r[1];if(App.page.startsWith(n,"/search/")){var i=decodeURI(n.substring(8));$("#txtSearch").val(i),a()}$("#txtSearch").select(),setTimeout(function(){$("#txtSearch").focus()},50),$("#txtSearch").keypress(function(t){if(13==(t.keyCode||t.which))return App.page.inPageNavigate("/?q="+encodeURI($("#txtSearch").val())),!1})}function a(){var t=$.ajax({url:"/api/search/go",type:"GET",contentType:"application/x-www-form-urlencoded; charset=UTF-8",data:{query:$("#txtSearch").val()}});t.done(function(t){r(t)}),t.fail(function(t,e,a){$(".results").text("Bunny is sad.")})}function r(t){for(var e="",a=0;a!=t.srcSegs.length;++a)e+="<div class='item'>",e+="<div class='source'>",e+=t.srcSegs[a],e+="</div>",e+="<div class='target'>",e+=t.trgSegs[a],e+="</div>",e+="</div>";$(".results").html(e)}return e(),{enter:e,move:e,name:"main"}},App.page.registerPage({name:"main",isMyRoute:function(t){return""==t||"/"==t||!!App.page.startsWith(t,"/search/")},getController:function(t){return App.xlate(t)}});