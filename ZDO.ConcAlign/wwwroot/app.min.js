...
var zsnippets={};
var App=App||{};App.page=function(){"use strict";function n(){var n=window.history.location||window.location,t=/https?:\/\/[^\/]+(.*)/i,e=t.exec(n);a=e[1];for(var i=!1,c=0;c<u.length;++c)if(u[c].isMyRoute(a)){null!=l&&l.name==u[c].name?l.move(a):l=u[c].getController(a),i=!0;break}i||r(),o()}function t(){return $(".popup").removeClass("visible"),history.pushState(null,null,this.href),n(),!1}function e(t){$(".popup").removeClass("visible"),history.pushState(null,null,t),n()}function o(){$(document).off("click","a.ajax",t),$(document).on("click","a.ajax",t)}function r(){$(".content-inner").html(zsnippets.badpage)}function i(n){return n.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var u=[],a=null,l=null;return $(document).ready(function(){n(),$(window).on("popstate",function(t){n()})}),{registerPage:function(n){u.push(n)},esc:i,path:function(){return a},showBadpage:r,inPageNavigate:e,reEnterCurrent:function(){l.enter()},startsWith:function(n,t){if(n.length<t.length)return!1;for(var e=t.length-1;e>=0&&n[e]===t[e];--e)continue;return e<0}}}();
var App=App||{};App.xlate=function(t){"use strict";function e(){var t=window.history.location||window.location,e=/https?:\/\/[^\/]+(.*)/i,n=e.exec(t),r=n[1];if(App.page.startsWith(r,"/?q=")){var i=decodeURI(r.substring(4));$("#txtSearch").val(i),a()}$("#txtSearch").select(),setTimeout(function(){$("#txtSearch").focus()},50),$("#txtSearch").unbind("keypress"),$("#txtSearch").keypress(function(t){if(13==(t.keyCode||t.which))return App.page.inPageNavigate("/?q="+encodeURI($("#txtSearch").val())),!1})}function a(){var t=$.ajax({url:"/api/search/go",type:"GET",contentType:"application/x-www-form-urlencoded; charset=UTF-8",data:{query:$("#txtSearch").val()}});t.done(function(t){n(t)}),t.fail(function(t,e,a){$(".results").text("Bunny is sad.")})}function n(t){for(var e="",a=0;a!=t.srcSegs.length;++a)e+="<div class='item'>",e+="<div class='source'>",e+=t.srcSegs[a],e+="</div>",e+="<div class='target'>",e+=t.trgSegs[a],e+="</div>",e+="</div>";$(".results").html(e)}return e(),{enter:e,move:e,name:"main"}},App.page.registerPage({name:"main",isMyRoute:function(t){return""==t||"/"==t||!!App.page.startsWith(t,"/?q=")},getController:function(t){return App.xlate(t)}});