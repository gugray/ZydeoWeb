...
var App=App||{};App.xlate=function(t){"use strict";function e(){$("#txtSearch").select(),setTimeout(function(){$("#txtSearch").focus()},50),$("#txtSearch").keypress(function(t){if(13==(t.keyCode||t.which))return n(),!1})}function n(){var t=$.ajax({url:"/api/search/go",type:"GET",contentType:"application/x-www-form-urlencoded; charset=UTF-8",data:{query:$("#txtSearch").val()}});t.done(function(t){r(t)}),t.fail(function(t,e,n){$(".results").text("Bunny is sad.")})}function r(t){for(var e="",n=0;n!=t.srcSegs.length;++n)e+="<div class='item'>",e+="<div class='source'>",e+=t.srcSegs[n],e+="</div>",e+="<div class='target'>",e+=t.trgSegs[n],e+="</div>",e+="</div>";$(".results").html(e)}return e(),{enter:e,name:"main"}},App.page.registerPage({name:"main",isMyRoute:function(t){return""==t||"/"==t},getController:function(t){return App.xlate(t)}});