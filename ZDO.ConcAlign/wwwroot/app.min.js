...
var App=App||{};App.xlate=function(e){"use strict";function t(){var e=$.ajax({url:"/api/search/go",type:"GET",contentType:"application/x-www-form-urlencoded; charset=UTF-8",data:{query:"sailor"}});e.done(function(e){a(e)}),e.fail(function(e,t,a){$(".results").text("Bunny is sad.")})}function a(e){for(var t="",a=0;a!=e.length;++a){var r=e[a];t+="<div class='item'>",t+="<div class='source'>";for(var s=0;s!=r.srcTokens.length;++s){var i=n(s,r.map),o=r.srcTokens[s];0!=s&&(t+=" "),""!=i&&(t+="<span data-pairixs='"+i+"'>"),t+=App.page.esc(o),""!=i&&(t+="</span>")}t+="</div>",t+="<div class='target'>";for(var s=0;s!=r.trgTokens.length;++s){0!=s&&(t+=" "),t+="<span data-ix='"+s+"'>";var o=r.trgTokens[s];t+=App.page.esc(o),t+="</span>"}t+="</div>",t+="</div>"}$(".results").html(t),$(".item .source span").mouseenter(function(){for(var e=($(this).data("pairixs")+"").split(" "),t=$(this).closest(".item").find(".target"),a=0;a!=e.length;++a){var n=t.find("[data-ix='"+e[a]+"']");n.addClass("hilite")}}),$(".item .source span").mouseleave(function(){$(".item .target span").removeClass("hilite")})}function n(e,t){for(var a="",n=0;n!=t.length;++n)t[n][0]==e&&(a.length>0&&(a+=" "),a+=""+t[n][1]);return a}return t(),{enter:t,name:"main"}},App.page.registerPage({name:"main",isMyRoute:function(e){return""==e||"/"==e},getController:function(e){return App.xlate(e)}});